...
function init() {
    ...
    $('#character_settings').click(function(){
        let nome = prompt("Nome:",character_data.nome);
        let razza = prompt("Razza:",character_data.razza);
        let classe = prompt("Classe:",character_data.classe);
        let livello = parseInt(prompt("Livello",character_data.livello));
